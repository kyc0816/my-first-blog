...
class Post(models.Model):
    ...
    ownername = models.CharField(max_length=20, default='주인 이름을 입력해주세요 (선택)')
    contact1 = models.CharField(max_length=30, default='비상연락망을 입력해주세요 (필수)')
    contact2 = models.CharField(max_length=50, default='추가 비상연락망을 입력해주세요 (선택)')
    address = models.CharField(max_length=100, default='주소를 입력해주세요 (선택)')
