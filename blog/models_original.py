...
class Post(models.Model):
    ...
    breed = models.CharField(max_length=20, default='Species of your pet')    #default='종을 입력해주세요')
    birthdate = models.CharField(max_length=20, default='Birthdate of your pet')    #default='출생 연도를 입력해주세요')
